...
function send_notification {
  iconSound="/usr/share/icons/Adwaita/16x16/status/audio-volume-high-symbolic.symbolic.png"
  iconMuted="/usr/share/icons/Adwaita/16x16/status/audio-volume-muted-symbolic.symbolic.png"
  if is_mute ; then
